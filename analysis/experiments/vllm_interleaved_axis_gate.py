...
class RecordingSink:
    ...
    def push(self, embeds, mrope, mrope_delta, final, *, correct_from=None):
    ...
    def correct(self, positions, embeds, window, final):
        ...
        self.msgs.append({"kind": "correct", "final": bool(final),
